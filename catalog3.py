...
def convert_to_dictionary_final(lst):
    ...
    for i in lst:
        ...
        dictionary_form[dept_code] = {'title': title, 'units': units, 'description': i[1], 'prerequisites': i[2]}
        ...
        if split_by_dash[0].count(' ') < 2:
            ...
            # Has letters at the end. Ex. "MATH 20A".
                ...
                if dept_code + letter not in finalized:
                    print [dept_code + letter, title, unit, value[1], value[2]]
                    print "\n"
                ...
                for j in split_by_dash[1:]:
                    ...
                    if dept_code not in finalized:
                        print [dept_code, title, unit, value[1], value[2]]
                        print "\n"
                        # finalized[dept_code] = {'title': title, 'units': units, 'description': value[1], 'prerequisites': value[2]}
                    else:
                        print(dept_code)
            ...
            for j in split_by_dash[1:]:
                print dept_code_letter_triplet[0] + " " + dept_code_letter_triplet[1] + j
